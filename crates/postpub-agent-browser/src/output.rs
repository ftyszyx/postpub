...
Usage: agent-browser open <url> [--wait-until <strategy>] [--timeout <ms>]
...
Global Options:
  ...
  --wait-until <strategy>  Navigation wait strategy: load, domcontentloaded, networkidle, none
...
Examples:
  ...
  agent-browser open https://mp.weixin.qq.com --wait-until domcontentloaded
  agent-browser open https://mp.weixin.qq.com --wait-until domcontentloaded --timeout 3000
...
Options:
  --timeout <ms>       Timeout in milliseconds for URL/load/function/text/download waits
